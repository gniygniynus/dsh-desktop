...
function applyCredentialsLocal() {
  return patchFile("node_modules/@deepseek-ai/dsh-credentials-local/lib/index.js", [
...
function applyApiproxy() {
  return patchFile("node_modules/@deepseek-ai/dsh-host-apiproxy/lib/index.js", [
    [
...
function applySettingsModels() {
  return patchFile("node_modules/@deepseek-ai/dsh-client-ui-settings-models/lib/client.js", [
...
function applyClientConnection() {
  return patchFile("node_modules/@deepseek-ai/dsh-client-connection/lib/client.js", [
    [
